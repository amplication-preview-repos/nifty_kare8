...
class ExchangeRateUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TransactionUpdateManyWithoutExchangeRatesInput,
  })
  @ValidateNested()
  @Type(() => TransactionUpdateManyWithoutExchangeRatesInput)
  @IsOptional()
  @Field(() => TransactionUpdateManyWithoutExchangeRatesInput, {
    nullable: true,
  })
  transactions?: TransactionUpdateManyWithoutExchangeRatesInput;
}

export { ExchangeRateUpdateInput as ExchangeRateUpdateInput };
