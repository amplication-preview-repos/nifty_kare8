...
@InputType()
class TransactionUpdateManyWithoutExchangeRatesInput {
...
export { TransactionUpdateManyWithoutExchangeRatesInput as TransactionUpdateManyWithoutExchangeRatesInput };
