...
class LedgerEntryUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => WalletUpdateManyWithoutLedgerEntriesInput,
  })
  @ValidateNested()
  @Type(() => WalletUpdateManyWithoutLedgerEntriesInput)
  @IsOptional()
  @Field(() => WalletUpdateManyWithoutLedgerEntriesInput, {
    nullable: true,
  })
  wallets?: WalletUpdateManyWithoutLedgerEntriesInput;
}

export { LedgerEntryUpdateInput as LedgerEntryUpdateInput };
