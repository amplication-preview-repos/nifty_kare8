...
@InputType()
class WalletCreateNestedManyWithoutLedgerEntriesInput {
...
export { WalletCreateNestedManyWithoutLedgerEntriesInput as WalletCreateNestedManyWithoutLedgerEntriesInput };
