...
@InputType()
class LedgerEntryCreateNestedManyWithoutTransactionsInput {
...
export { LedgerEntryCreateNestedManyWithoutTransactionsInput as LedgerEntryCreateNestedManyWithoutTransactionsInput };
