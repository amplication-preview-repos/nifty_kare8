...
export class TransactionControllerBase {
  ...
  async findLedgerEntries(
    ...
    const query = plainToClass(LedgerEntryFindManyArgs, request.query);
    const results = await this.service.findLedgerEntries(params.id, {
      ...query,
      select: {
        amount: true,
        createdAt: true,
  ...
  @common.Post("/:id/ledgerEntries")
  @nestAccessControl.UseRoles({
    resource: "Transaction",
    action: "update",
    possession: "any",
  })
  async connectLedgerEntries(
    @common.Param() params: TransactionWhereUniqueInput,
    @common.Body() body: LedgerEntryWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      ledgerEntries: {
        connect: body,
  ...
  @common.Delete("/:id/ledgerEntries")
  @nestAccessControl.UseRoles({
    resource: "Transaction",
    action: "update",
    possession: "any",
  })
  async disconnectLedgerEntries(
    @common.Param() params: TransactionWhereUniqueInput,
    @common.Body() body: LedgerEntryWhereUniqueInput[]
  ): Promise<void> {
    const data = {
