...
export class WalletResolverBase {
  ...
  async createWallet(@graphql.Args() args: CreateWalletArgs): Promise<Wallet> {
    return await this.service.createWallet({
      ...
      data: {
        ...
        ledgerEntry: args.data.ledgerEntry
          ? {
              connect: args.data.ledgerEntry,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => LedgerEntry, {
    nullable: true,
    name: "ledgerEntry",
  })
  @nestAccessControl.UseRoles({
  ...
  async getLedgerEntry(
    ...
    const result = await this.service.getLedgerEntry(parent.id);
